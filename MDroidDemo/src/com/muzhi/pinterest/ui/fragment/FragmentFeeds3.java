...
import com.muzhi.pinterest.datas.ImageData;
...
public class FragmentFeeds3 extends BaseFragment {
        ...
        mListView.setXListViewListener(new XMultiColumnListView.IXListViewListener() {
			...
			public void onRefresh() {
				// TODO Auto-generated method stub
				 AddItemToContainer(++pageindex, 1);
			}
			
			@Override
			public void onLoadMore() {
				// TODO Auto-generated method stub
				AddItemToContainer(++pageindex, 2);
			}
		});
	...
	private void getList(){
		...
		ImageData.getImageList(1, mHandler, 1);
