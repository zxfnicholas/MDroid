...
public abstract class MBaseActivity extends SwipeBackActivity{
	...
	protected void showAlertDialog(String message,String yes,String no,OnClickListener clickCallBack){
		...
		customBuilder.setNegativeButton(yes, clickCallBack);
		customBuilder.setPositiveButton(no, clickCallBack);
